// $Id: nrutil_tnt.h,v 1.2 2008/07/15 03:52:14 samn Exp $ 
#ifndef _NR_UTIL_H_
#define _NR_UTIL_H_
...
namespace NR {
	...
	{
		Write2Log("Numerical Recipes run-time error...");
		Write2Log("%s",error_text.c_str());
		Write2Log("...now exiting to system...");
		//exit(1);
	}
}
