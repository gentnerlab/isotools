// $Id: nr.h,v 1.3 2008/08/11 20:59:21 samn Exp $ 
#ifndef _NR_H_
#define _NR_H_
#include <fstream>
#include <complex>
...
bool ludcmp(Mat_IO_DP &a, Vec_O_INT &indx, DP &d);

void lubksb(std::vector< std::vector< float> >& a, std::vector<int>& indx, std::vector<float>& b);
bool ludcmp(std::vector< std::vector< float> >& a, std::vector<int>& indx, float& d);

void lubksb(std::vector< std::vector< double> >& a, std::vector<int>& indx, std::vector<double>& b);
bool ludcmp(std::vector< std::vector< double> >& a, std::vector<int>& indx, double& d);

void lubksb(A2D< double>& a, std::vector<int>& indx, double* b);
bool ludcmp(A2D< double>& a, std::vector<int>& indx, double& d);
...
DP pythag(const float a, const float b);
...
void svdcmp(vector<vector<float> > &a, vector<float> &w, vector<vector<float> > &v);
